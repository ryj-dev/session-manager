 ...
 */
export function registerMcpServer(serverScriptPath: string, memoriesDir: string, dataDir: string, notesDir?: string, embedSocketPath?: string, wikiDir?: string): void {
